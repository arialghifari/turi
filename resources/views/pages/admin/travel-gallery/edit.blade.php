...
<main class="h-full overflow-y-auto">
  <div class="container px-6 mx-auto grid space-y-6 my-6">
    <div class="">
      <h2 class="text-sm font-medium text-gray-700"><a href="{{ route('travel-gallery.index') }}" class="underline text-blue-500">Travel Gallery</a> / Edit</h2>
    </div>
    ...
    @method("PUT")
      <div class="flex flex-col space-y-4 mb-8 px-4 py-3 bg-white rounded-lg shadow-md">
        ...
        <label class="text-sm">
          ...
          <a class="underline text-blue-500" href="{{ Storage::url($item->image) }}" target="_blank">see current image</a>
          <input
          ...
          />
          <span class="text-red-400 text-xs">*Ignore this if you don't want to change the image</span>
